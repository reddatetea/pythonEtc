...
class Tokenizer(object):
    ...
    def _parse_error(self):
        ...
        raise TokenizerError("Invalid error code at position {} in '{self.formula}'".format(self.offset))
    ...
    def assert_empty_token(self, can_follow=()):
        ...
        if self.token and self.token[-1] not in can_follow:
            ...
            raise TokenizerError("Unexpected character at position {self.offset} in '{}'.format(self.formula)")
